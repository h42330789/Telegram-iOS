...
public class ChatMessageFactCheckBubbleContentNode: ChatMessageBubbleContentNode {
    ...
    class ChatMessageFactCheckBubbleContentNodeView: ChatMessageBubbleContentNode.ChatMessageBubbleContentNodeView { }
    // 提在ASDisplayNode的子类里重写viewClass方法，返回个_ASDisplayView的子类的类型即可
    override open class func viewClass() -> AnyClass {
        return ChatMessageFactCheckBubbleContentNodeView.self
    }
#endif
